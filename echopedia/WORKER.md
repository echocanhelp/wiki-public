...
| P2 | Publish/deploy | Push to live | 1. `echopedia-publish.sh --push` 2. Verify smoke URLs 3. Report |
...
| P13 | Site design | Layout issues | 1. Read site-design-brief.md 2. Run audit 3. Propose fixes 4. Report |
