## Site design audit — 2026-09-15 04:30
...
### MEDIUM (1)
- **F4** people/index.html is 1495798 bytes — heavy on mobile. Do NOT hand-edit content/people/index.md. Search-first is the IA; regen script only if links break.

### LOW (1)
- **C1** spelling signals (sample): 2 `[AGENT_SUGGESTED]`
  - `ching-sze-hsieh.md: ?ching`
  - `ching-yun-hu.md: ?ching`
...
- **B2** pinned featured pages: 6 (cap 6 people + 3 orgs; overflow hides recency)
  ...
  - `people/yang-xin.md`
- **B1** person/org touched ≤7d (rely on recency featured window): 737
  - `people/agnes-hsu.md`
  - `people/ahhee-hsu.md`
