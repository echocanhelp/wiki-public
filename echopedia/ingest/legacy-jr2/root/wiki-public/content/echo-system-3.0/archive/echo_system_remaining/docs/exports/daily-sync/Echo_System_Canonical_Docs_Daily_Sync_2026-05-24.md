...
|---|---|---|---|---|---|
| master_index | `Echo_System_Master_Index.md` | Canonical entry point, version table, authority map, deprecation map, latest integrity state | Archivist | Updated | 1.6.2 |
...
| agent_prompts | `Echo_System_Agent_Prompts.md` | Single canonical prompt file for Echo System role prompts and shared runtime governance | Orchestrator | Updated — Config-Driven Routing + Count Language Unification | 1.9.0 |
| operations_guide | `Echo_System_Operations_Guide.md` | Deployment, operations, extension, recovery, maintenance, and operator procedures | Orchestrator + Hermes core | Updated — Runtime Alignment Cleanup | 1.3.1 |
...
Version: 2.0.0
Status: Updated — Unified Output Contracts + Config-Driven Runtime Alignment
Last Updated: 2026-05-24
...
Version: 1.3.1
Status: Updated — Runtime Alignment Cleanup
Last Updated: 2026-05-24
