...
- Generated_at: 2026-05-09T17:02:48.931288-07:00
...
|---|---|---|
| Twilio / SMS | EchoHsu | Active public-facing community intake |
| LINE | EchoHsu | Planned public community channel when enabled |
...
- `hermes-gateway-echohsu.service` for EchoHsu SMS ingress
...
- echohsu owns SMS
- LINE remains documented as planned until live
...
- always-on ingress/control-plane services
- on-demand specialist workers by default
- verified ownership boundaries for Telegram, Discord, SMS, and future LINE activation
...
- LINE is part of the target deployment shape but not assumed live until verified
...
- Channel surfaces: Twilio/SMS public intake, Telegram developer support, Discord orchestrator operations, LINE planned public channel
- Always-on runtime services: `hermes-gateway.service`, `hermes-gateway-orchestrator.service`, `hermes-gateway-echohsu.service`, `echo-autoloop.service`
...
## 12. EchoHsu — Multi-Platform Community Weaver (Public Face)
...
- LINE: documented and planned until live verification says otherwise
...
- echohsu gateway for Twilio/SMS public ingress
...
- Twilio/SMS or future LINE public conversations enter through EchoHsu
...
LINE is part of the target deployment shape but must remain documented as planned until live verification confirms:
...
- channel ownership map for Telegram, Discord, and SMS
