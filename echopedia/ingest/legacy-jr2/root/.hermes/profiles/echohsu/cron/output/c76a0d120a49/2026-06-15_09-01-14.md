...
**Echopedia Homepage Curator Report (2026-06-15)**

- **Action**: Ran full v1 curator workflow via `curator.py`
- **Result**: Featured People list **changed** → both `index.md` files updated
- **New top 6 people** (ranked by depth + recency, after aggressive filtering):
  1. Rev. Mingyuan Hsu (許明遠)
  2. Rev. David Huang (黃德利)
  3. Dr. Albert S. Lai (賴信雄)
  4. Elder Deng Shuzhen (鄧淑貞長老)
  5. Rev. Pinghsi Liu (劉炳熹)
  6. Willy Pan (潘建宇)
- **Deploy**: Committed + pushed to `wiki-deploy` (master branch)
- **Institutional Memory section**: Unchanged (hardcoded in v1)
- **Notes**: Trailing notes preserved where applicable; byte-identical files maintained
