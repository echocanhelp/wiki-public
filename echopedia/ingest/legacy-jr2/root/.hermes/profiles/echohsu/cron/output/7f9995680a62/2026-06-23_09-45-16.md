# Cron Job: Echopedia Daily Accuracy & Link Audit (FAILED)

**Job ID:** 7f9995680a62
**Run Time:** 2026-06-23 09:45:15
**Schedule:** 45 9 * * *
...
```
ImportError: cannot import name 'PARALLEL_TOOL_CALL_GUIDANCE' from 'agent.prompt_builder' (/usr/local/lib/hermes-agent/agent/prompt_builder.py)
```
