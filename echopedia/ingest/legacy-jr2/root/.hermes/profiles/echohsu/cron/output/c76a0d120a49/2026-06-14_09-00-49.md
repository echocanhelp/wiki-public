...
- Use a single Python script for filtering + frontmatter parsing + ranking rather than chaining multiple shell commands; this avoids fragile glob/exclude logic and makes title extraction reliable.
