...
def _hermes_home() -> Path:
    ...
    # Profile-aware fallback: if this script is running from
    # ~/.hermes/profiles/<name>/skills/... infer that profile's home.
...
def _json_request(
    ...
    *,
    ...
    request_headers.setdefault("User-Agent", "Mozilla/5.0 (compatible; HermesTelephony/1.0)")
