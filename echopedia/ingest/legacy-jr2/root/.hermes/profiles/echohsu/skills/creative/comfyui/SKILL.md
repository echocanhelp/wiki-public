...
- `portrait-i2v-reference-workflow.md` — prompt/settings/checklist pattern for
  respectful portrait image-to-video generation from an approved real-person
  reference photo, including identity preservation and post-production text
  overlay guidance.
