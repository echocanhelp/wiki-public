...
- **Digital bulletins:** Weekly bulletins and sermon listings (e.g. preaching by [[people/mingyuan-hsu|Rev. Ming Yuan Hsu]]) on the [bulletin archive](https://gstpc.org/home/bulletin-archive/).

Historical schedule notes on the about page have listed additional discipleship and student fellowship times; confirm current times on the official site or latest bulletin.
...
- **Media and resources** — Devotion archives, discipleship materials, and anniversary publications (including a [40th anniversary eBook](https://gstpc.org/home/get/gstpc40-ebook)).
- **TPC live stream** — Related Taiwanese Presbyterian Council worship programming linked from the site.
