---
title: "Elder John Lai's Archives (laijohn.com)"
type: source
tags:
  - source
  - church
...
- **No sitemap.xml.** HTTP. Google CSE on-site.

## What the site covers

| Cluster | URL | v1? |
|---|---|---|
| ZH home / 識 | http://www.laijohn.com/Index.htm | yes |
| EN home | http://www.laijohn.com/English/Home.htm | yes |
| 生平 | http://www.laijohn.com/life/biog.htm | yes |
| 著作目錄 | http://www.laijohn.com/works/works-contents.htm | TOC only |
| 《教會史話》總目 | http://www.laijohn.com/contents.htm | TOC only |
| 本土信徒 | http://www.laijohn.com/archives/pc-contents.htm | **no** (firehose) |
| PCT / 宣教師 / 馬偕 | `/PCT/` `/missionaries/` `/Mackay/` | not v1 |
