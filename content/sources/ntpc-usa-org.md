---
title: "NTPC USA (National Taiwanese Presbyterian Council, Presbyterian Church (U.S.A.))"
type: source
tags:
  - source
  - church-council
...
- **Entity / fact index:** `knowledge/research/ntpc-usa-org-entities.md`
- **Canonical primary:** `content/organizations/national-taiwanese-presbyterian-council.md`
- **Disambiguation:** `content/organizations/ntpc.md` (do not overwrite)

## What the archive covers

| Cluster | Example archive files | Absorb |
|---|---|---|
| Home / 組織 / 規章 | ntpc-usa-org-home, ntpc-usa-org-組織, ntpc-usa-org-組織-ntpc-規章-bylaw | History / Mission / membership / 設立 on primary |
| 執行委員會 | ntpc-usa-org-組織-執行委員會 | 2025/26 執委 table on primary; dossier for named officers |
| 事工委員會 | ntpc-usa-org-組織-事工委員會 | Committee structure table |
| NTPW | ntpc-usa-org-ntpw | 2025 NTPW exec table |
| 年會 | ntpc-usa-org-home (letters), ntpc-usa-org-活動記錄摘要 | Annual conference timeline |
| 聘牧 / 教會消息 | ntpc-usa-org-聘牧及教會消息 | List only; no stub per ad |
| 靈修 / 學習 | ntpc-usa-org-靈修與學習-* | Source index only; no sermon firehose |
| 聯絡 | ntpc-usa-org-聯絡 | Contact info |
| 網站連接 | ntpc-usa-org-網站連接 | External links |

**Not on-domain (not archived):** Google Forms, aatpc.us, editor CDN, taigi.fhl.net.

**PDFs listed-only (not archived):** 50th anniversary invitation PDF, 50th schedule PDF, 2023 invitation PDF, 2020 registration form PDF.
...
5. Bylaws → cite + archive; do not paste full text
6. Annual conferences → timeline table on primary
7. NTPC CAN HELP → paragraph on primary

## Officers (2025/26, from this site)

| Role | Name | Slug |
|---|---|---|
| 主席 | 葉芸青 | people/yunching-yeh-davis |
| 副主席 | 陳慧貞 | people/chen-hui-chen |
| 書記 | 謝信光 | people/xie-xinguang |
| 會計 | 張愛惠 | people/zhang-aihui |
| 委員 | 林育武 | people/lin-yushu |
| 委員 | 賴懿文 | — |
| 委員 | 陳晉祿 | — |
| NTPYAC 會長 | 從缺 | — |
