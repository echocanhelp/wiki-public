...
- **Entity / fact index:** `knowledge/research/itpc-entities.md`

## What the archive covers

| Cluster | Example archive files |
|---------|----------------------|
| About | itpc-about_us, itpc_contact |
| Ministries | itpc_ministries, itpc_youth |
| Resources | itpc_resources, itpc_forms |
| Bulletin | itpc_bulletin, itpc_event |
