...
- **Entity / fact index:** `knowledge/research/gstpc-entities.md`

## What the archive covers

| Cluster | Example archive files |
|---------|----------------------|
| About | gstpc-about, gstpc-tpc |
| Ministries | gstpc-ministries, gstpc-youth |
| Bulletin | gstpc-bulletin-archive.md |
| Devotion | gstpc-devotion-archive.md |
| Resources | gstpc-resources, gstpc-forms |
