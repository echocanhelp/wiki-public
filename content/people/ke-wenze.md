...
**Ko Wen-je / Ke Wen-ze** (柯文哲) appears extensively in the [[sources/taiwanjustice-net||taiwanjustice.net]] archive (**167** article hits by title/topic extraction). This is a **thin A-tier** page for graph linking — not a full biography.

## Identity Snapshot

- **English:** Ko Wen-je / Ke Wen-ze
- **Chinese:** 柯文哲
- **Role (as covered):** Former Mayor of Taipei; Taiwan People's Party figure
- **Echopedia scope:** Taiwan politics coverage via taiwanjustice.net; not a Taiwanese-American diaspora profile

## Source Notes

- **Content priority A:** Article hit count (167) from `knowledge/research/taiwanjustice-net-entities.md` (title extraction)
