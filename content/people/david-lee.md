...
- **待補** — company, title outside TAHS, city/region, or other public roles you want on the record (optional; private contact details will not be published)
...
- **待補** — what you actually own day-to-day (infra, website, archives, AI/agent ops, etc.)
