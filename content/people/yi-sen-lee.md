...
Listed on the TAHS 2025 organization chart as Special assistant. Owner confirmed LINE `Yi Lee` = **Yi Sen Lee** = chart name **李意盛** (handwritten "Yi-Sen Lee" on org chart, 2026-08-03).

Private phones and LINE U-ids are **not** published here.

## TAHS role (2025)

- **Title:** 特別助理 (Special assistant)
- **Source:** TAHS 2025 organization chart (台美人歷史協會組織表), Tax ID 46-4005384

## LINE

- displayName: `Yi Lee`
- Preferred EN: **Yi Sen Lee**
...
**yi-sen-lee** has **0** articles where they appear in the title (column articles) and **1** additional articles that mention them in the body.
