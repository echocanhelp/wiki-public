...
- deepen-x 09141213-21：語料庫檢索僅命中自身 TAH 出處頁 #265、#531 及 works index 條目行，無回憶錄／社群一手材料可吸收 — **SKIP（理由：無非出處頁語料）**。
...
- deepen-x 09150600-9（2026-09-15 覆核）：再 grep 命中僅自身出處頁 #265、#531、works index 條目行，另有 #1999 Pei-Jung Lin（林佩蓉，另一人）slug 假性命中 — 維持 **SKIP（理由：無非出處頁語料）**。
