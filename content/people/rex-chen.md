...
A business card shared during onboarding identifies Rex Chen as First Vice President and Relationship Manager at EverTrust Bank, a subsidiary of O-Bank. Public contact details from the card are intentionally not republished here.

## Testimony / Self-Introduction (Member-editable)

> Pending Rex Chen's first-person introduction.

## Contributions / Responsibilities

- TAHS membership and community relationship context pending Rex Chen's confirmation.
...
- LINE profile linkage: owner-confirmed and privately verified; exact LINE user ID is not published.
...
- Chinese name 陳乃光 was provided by Rex Chen from his own LINE sender account in the onboarding group.
- Leonard Hsu Jr.'s Chinese name is 許景鴻; a prior attribution error placed Rex Chen's Chinese name on Leonard's page and has been corrected.
- LINE group mention label was visible as “Rex Chen,” and subsequent Rex-sender messages provided identity confirmation.
- Professional affiliation is based on the business card image shared during onboarding and should be confirmed by Rex Chen before expanding the biography.
